// Shared by the Landing page's FAQ section and the full /faq page — one
...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Looppr launches August 1, 2026 across the OKC metro — Oklahoma City, Edmond, Norman, and Moore.',
  },
  {
    question: 'How long does a typical order take?',
    answer:
      "About 24 hours on average from pickup to delivery, depending on your laundry pro's current load and the size of your order.",
  },
  {
