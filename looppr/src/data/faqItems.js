...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Looppr is available now across the OKC metro - Oklahoma City, Edmond, Norman, and Moore - with Indianapolis coming in January 2027. Visit our cities & coverage page to check your city and join the waitlist if we\'re not there yet.',
    linkTo: '/cities',
