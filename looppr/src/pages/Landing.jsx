        ...
        <div className="relative mx-auto grid max-w-[1600px] gap-12 px-4 sm:px-6 lg:px-8 pb-20 pt-16 md:grid-cols-2 md:items-center md:pb-28 md:pt-24">
          <div>
            ...
            <div className="mt-10 flex flex-wrap gap-8">
              ...
              <div>
                <span className="block font-display text-2xl font-semibold text-ink">1 city live</span>
                <span className="text-xs text-ink/50">Indianapolis, IN now available</span>
              </div>
            </div>
          </div>
