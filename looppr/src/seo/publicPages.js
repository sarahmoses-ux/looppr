...
export const PUBLIC_PAGES = [
  {
    ...
    keywords: ['laundry pickup and delivery', 'laundry service', 'laundry near me', 'wash and fold', 'laundry marketplace'],
    changefreq: 'weekly',
    priority: 1.0,
  },
  {
    ...
    keywords: ['laundry pickup and delivery', 'laundry service sign up'],
    changefreq: 'monthly',
    priority: 0.8,
  },
  {
    ...
    keywords: ['laundry pickup and delivery', 'guest laundry order'],
    changefreq: 'monthly',
    priority: 0.7,
  },
  {
  ...
  },
  {
    ...
    keywords: ['laundry marketplace', 'laundry service', 'about looppr'],
    changefreq: 'monthly',
    priority: 0.6,
  },
  {
  ...
  },
  {
    ...
    keywords: ['laundry marketplace', 'laundromat partner', 'dry cleaning', 'laundry service near me'],
    changefreq: 'monthly',
    priority: 0.6,
  },
  {
    ...
    keywords: ['laundry pickup and delivery driver', 'delivery driver jobs'],
    changefreq: 'monthly',
    priority: 0.6,
  },
  {
    ...
    keywords: ['laundry service pricing', 'laundry pickup and delivery cost'],
    changefreq: 'monthly',
    priority: 0.8,
  },
  {
    ...
    keywords: ['hotel laundry services', 'commercial laundry service', 'linen service'],
    changefreq: 'monthly',
    priority: 0.6,
  },
  {
    ...
    keywords: ['laundry near me', 'laundry pickup and delivery', 'laundry service coverage area'],
    changefreq: 'weekly',
    priority: 0.7,
  },
  {
    ...
    keywords: ['laundry service faq', 'laundry pickup and delivery questions'],
    changefreq: 'monthly',
    priority: 0.6,
  },
  {
  ...
  },
  {
    ...
    keywords: ['laundry marketplace', 'become a laundromat partner', 'dry cleaning partner'],
    changefreq: 'monthly',
    priority: 0.6,
  },
