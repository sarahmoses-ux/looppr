...
export const PUBLIC_PAGES = [
  ...
  {
    path: '/business/airbnb-hosts',
    title: 'Laundry service for Airbnb superhosts',
    description: 'Looppr picks up guest linens after checkout and returns them washed, folded and ready — built for Airbnb superhosts running fast turnovers.',
    keywords: ['airbnb laundry service', 'short term rental linen service', 'vacation rental laundry'],
    changefreq: 'monthly',
    priority: 0.5,
  },
  {
  ...
  {
    path: '/business/gyms-studios',
    title: 'Laundry service for gyms & studios',
    description: 'Looppr handles daily towel and mat laundry for gyms and studios, picked up and returned on a schedule matched to your class times.',
    keywords: ['gym towel service', 'fitness studio laundry', 'commercial towel laundry service'],
    changefreq: 'monthly',
    priority: 0.5,
  },
  {
    path: '/business/med-spas-salons',
    title: 'Laundry service for med spas & salons',
    description: 'Gentle-care laundry for med spa and salon treatment linens, robes and staff smocks — picked up and returned on your appointment schedule.',
    keywords: ['med spa linen service', 'salon laundry service', 'spa robe laundry'],
    changefreq: 'monthly',
    priority: 0.5,
  },
  {
